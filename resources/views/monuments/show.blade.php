...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <nav class="flex mb-8" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                @php
                    $returnLat = request('return_lat', $monument->latitude);
                    $returnLng = request('return_lng', $monument->longitude);
                    $returnZoom = request('return_zoom', 15);
                @endphp
                <a href="{{ route('monuments.map') }}?lat={{ $returnLat }}&lng={{ $returnLng }}&zoom={{ $returnZoom }}&selected={{ $monument->id }}" class="text-gray-700 hover:text-gray-900 whitespace-nowrap inline-flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            ...
            @else
            <a href="{{ route('auth.login', ['return_url' => url()->current()]) }}" 
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <dl class="space-y-4">
                    ...
                    @if(isset($monument->properties["instance_of_label_tr"]) && $monument->properties["instance_of_label_tr"])
                        <div>
